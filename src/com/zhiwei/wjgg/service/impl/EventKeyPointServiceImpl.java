 ...
 */
@Service
public class EventKeyPointServiceImpl extends GeneralServiceImpl implements
        EventKeyPointService
{

    @Resource
    private EventKeyPointDao dao;

    @Override
    public boolean add(EventKeyPoint ob)
    {

        try
        {
            EventKeyPoint new_ob = dao.insert(ob);
            if (null != new_ob)
            {
                return true;
            }
    ...
    @Override
    public boolean updata(EventKeyPoint ob)
    {
    ...
    @Override
    public boolean delete(EventKeyPoint ob)
    {
        boolean result = false;
        try
        {
    ...
    @Override
    public boolean search(EventKeyPoint ob)
    {
        boolean flag = false;
        try
        {
    ...
    @Override
    public EventKeyPoint findOneById(String id)
    {
        EventKeyPoint ob = null;
        try
        {
            ob = dao.findOne(id);
        }
    ...
    @Override
    public List<EventKeyPoint> findAll(Object... ob)
    {
    ...
    @Override
    public EventKeyPoint findByEventIdInTime(String eventId, String type)
    {
        EventKeyPoint ob = null;
    ...
    @Override
    public boolean addInfoByOb(EventKeyPoint ob)
    {
        boolean flag = false;
        try
        {

            EventKeyPoint ob_old = dao.findOne(ob);
            if (null == ob_old)
            {
                dao.insert(ob);
                flag = true;
        ...
        {
            log.error("添加信息出错：{}", e.getMessage());
        }
        return flag;
    }

    @Override
    public boolean deleteInfoByOb(EventKeyPoint ob)
    {
        boolean flag = false;
        try
        {
