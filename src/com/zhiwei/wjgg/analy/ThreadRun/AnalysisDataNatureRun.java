...
public class AnalysisDataNatureRun<T extends DataCommon> implements Runnable
{
    ...
    public void run()
    {
        ...
        addNatureTrend(natureMap, event);
    }
     ...
     * @return void 返回类型
     */
    private void addNatureTrend(Map<String, Map<String, Double>> natureMap, Event event2)
    {
        ...
        for (String type : natureMap.keySet())
        {
            ...
            natureTrendService.addInfoByOb(natureTrend);
        }
     ...
     * @return
     */
    public AnalysisDataNatureRun(AnalyDataService analyService, List<T> dataList, NatureTrendService natureTrendService,
        Event event)
    {
        super();
        this.analyService = analyService;
        this.dataList = dataList;
        this.natureTrendService = natureTrendService;
        this.event = event;
    }
}
