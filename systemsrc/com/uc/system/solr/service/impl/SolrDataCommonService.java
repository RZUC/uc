...
public abstract class SolrDataCommonService<T> implements SolrDataService {
	public final static Logger log = LoggerFactory
			.getLogger(SolrDataCommonService.class);
	 ...
	 */
	public SolrDocumentList getSolrDataWithHUserInfo(SearchQuery query,
			Page page) {
	...
	public SolrDocumentList getSearchPolicyInfoView(SearchQuery query, Page page) {
