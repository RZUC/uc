 ...
 */
public class SolrMarkWexinReplenishImplTest extends ObjectTest
{
    @Resource(name = "solrMarkWexinReplenishImpl")
    private SolrDao markWeiXin;
    ...
    public void getDataTest()
    {
        ...
        SolrDocumentList lis = markWeiXin.getData(event, null);
