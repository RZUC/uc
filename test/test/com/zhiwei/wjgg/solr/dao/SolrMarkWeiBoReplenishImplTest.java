 ...
 */
public class SolrMarkWeiBoReplenishImplTest extends ObjectTest
{
    @Resource(name = "solrMarkWeiboDaoReplenish")
    private SolrDao markWeibo;
    ...
    public void getDataTest()
    {
        ...
        SolrDocumentList lis = markWeibo.getData(event, null);
