...
public interface CommonDao<T>
{
     ...
     * 插入
     */
    public T insert(T ob) throws ZhiWeiException;

    /*
     * 按id查
     */
    public T findOne(String id) throws ZhiWeiException;

    /*
     * 按对象查
     */
    public T findOne(T ob) throws ZhiWeiException;

    /*
     * 查询全部
     */
    public List<T> findAll() throws ZhiWeiException;
     ...
     * 改
     */
    public boolean findAndModify(T ob) throws ZhiWeiException;
