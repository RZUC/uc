...
public class LocationDaoTest extends ObjectTest {
	...
	public void addTest() throws ZhiWeiException {
		...
		Map<String, Object> map = null;// simple.readExcel(new
										// File("E:\\areas.xls"), "areas");

		for (String sheetName : map.keySet()) {
			Map<String, Object> sheet = (Map<String, Object>) map
					.get(sheetName);
			System.out.println("sheetName:" + sheetName);
			List<String> headList = (List<String>) sheet.get("head");
			List<Map<String, Object>> body = (List<Map<String, Object>>) sheet
					.get("body");
			...
			for (Map<String, Object> map2 : body) {
				...
				// Location location =
				// new Location(Integer.valueOf(id), locationName, fatherID,
				// abbreviation, longitude, dimensionality, level, order);
				// dao.insert(location);
			}
		}
	...
	public void findOneTest() throws ZhiWeiException {
		...
		for (Location location : dao.findOneByFiled("_id", ids)) {
