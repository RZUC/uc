...
public class UserController extends GeneralController
{
    ...
    public ResponseEntity<Map> navigation(HttpSession session)
        throws Exception
    {
    ...
    {
        String and = "&";
        StringBuffer buf = new StringBuffer(urlBase + "/search.do?policyTypeId=" + type.getId());
    ...
    public ResponseEntity<Map> collect(@RequestParam(value = "uid") int uid,
        @RequestParam(value = "policyInfoId") int policyInfoId, @RequestParam(value = "summary") String summary)
        throws Exception
    {
        Map<String, Object> message = new HashMap<String, Object>();
        Favorite newFavorite = new Favorite(uid, policyInfoId, summary);
        if (!favoriteService.isExist(newFavorite))
        {
            Favorite f = favoriteService.collect(newFavorite);
            
            if (f != null)
            {
                message.put("message", "为用户【" + uid + "】添加：" + policyInfoId + "收藏成功");
            ...
            {
                message.put("message", "为用户【" + uid + "】添加：" + policyInfoId + "收藏失败");
    ...
    public ResponseEntity<Map> unCollect(@RequestParam(value = "favoriteId") String favoriteId)
        throws Exception
    {
