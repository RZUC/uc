 ...
 */
public class SolrMarkMediaReplenishImplTest extends ObjectTest
{
    @Resource(name = "solrMarkMediaReplenishImpl")
    private SolrDao markMedia;
    ...
    public void getDataTest()
    {
        ...
        SolrDocumentList lis = markMedia.getData(event, null);
