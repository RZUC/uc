 ...
 */
public class NatureKeyPointDaoTest extends ObjectTest
{
    @Resource
    NatureKeyPointDao dao;
    ...
    public void showTest()
    {
        try
        {
            List<NatureKeyPoint> a = dao.findAll();
            for (NatureKeyPoint ob : a)
            {
                System.out.println(ob.getTime_content());
            }
        }
        catch (ZhiWeiException e)
        {
    ...
    public void findByEventIdInTime()
    {
        ...
        String type = "中性";
        NatureKeyPoint ob = dao.findByEventIdInTime(eventId, type);
